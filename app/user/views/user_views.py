...
from app.user.serializers.user_serializers import UserSerializer
...
class UsuarioViewSet(Authentication,viewsets.ModelViewSet):
    ...
    def update(self, request, pk=None):
        try:
            if self.get_queryset(pk):
                ...
                return ResponseData.Response(TYPECODE.SI, TYPECODE.BAD_REQUEST, MESSAGE.BAD_REQUEST, user_serializer.errors, status.HTTP_400_BAD_REQUEST)
            return ResponseData.Response(TYPECODE.SI, TYPECODE.NOT_FOUND, MESSAGE.NOT_FOUND, MESSAGE.NULL, status.HTTP_404_NOT_FOUND)
        except:
            return ResponseData.Response(TYPECODE.SI, TYPECODE.INTERNAL_ERROR, MESSAGE.INTERNAL_ERROR, MESSAGE.NULL, status.HTTP_500_INTERNAL_SERVER_ERROR)
    ...
    def destroy(self, request, pk=None):
        try:
            ...
            if user:
                user.state = 'I'
                user.id_user_modified = request.data['id_user_modified']
                user.save()
